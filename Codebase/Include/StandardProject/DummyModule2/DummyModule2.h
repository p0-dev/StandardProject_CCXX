...
** NAME             | DummyModule2.h
** --------------------------------------------------------------------------------------
** LOCATION         | Root/Codebase/Include/DummyModule2/DummyModule2.h
** --------------------------------------------------------------------------------------
** DESCRIPTION      | Header file for DummyModule2
-------------------------------------------------------------------------------------- */


#ifndef __DUMMY_MODULE_2_H__   
#define __DUMMY_MODULE_2_H__   
